...
class ColorWrapper(gym.Wrapper):
	...
	def _load_colors(self):
		...
		self._colors = torch.load(f'/aiarena/nas/svea-jacobian/src/env/data/{self._mode}.pt')
...
class VideoWrapper(gym.Wrapper):
	...
	def _get_video_paths(self):
		video_dir = os.path.join('/aiarena/nas/svea-jacobian/src/env/data', self._mode)
