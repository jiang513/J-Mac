...
def parse_args():
    ...
    parser.add_argument("--log_dir", default="/aiarena/nas/robot_env/logs_drq_test", type=str)
    ...
    # args.max_train_steps = int(args.max_train_steps.replace("k", "000"))
    # args.train_average_record_freq = int(args.train_average_record_freq.replace("k", "000"))
    # args.train_time_record_freq = int(args.train_time_record_freq.replace("k", "000"))
